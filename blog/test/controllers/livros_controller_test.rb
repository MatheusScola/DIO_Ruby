...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference("Livro.count") do
      post livros_url, params: { livro: { assessment: @livro.assessment, bookAuthor: @livro.bookAuthor, description: @livro.description, integer: @livro.integer, text: @livro.text, title: @livro.title } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { assessment: @livro.assessment, bookAuthor: @livro.bookAuthor, description: @livro.description, integer: @livro.integer, text: @livro.text, title: @livro.title } }
